...
final public class FirstMessageRequestHandler implements MessageHandler<FirstRequest, AgentStartedEvent, com.neeve.demo.custservice.state.Repository> {
    ...
    final public MessageView handle(final String origin,
                                    ...
                                    final com.neeve.demo.custservice.state.Repository repository) throws Exception {
