...
final public class FirstMessageRequestHandler implements MessageHandler<FirstRequest, AgentStartedEvent, com.neeve.demo.analyticsservice.state.Repository> {
    ...
    final public MessageView handle(final String origin,
                                    ...
                                    final com.neeve.demo.analyticsservice.state.Repository repository) throws Exception {
