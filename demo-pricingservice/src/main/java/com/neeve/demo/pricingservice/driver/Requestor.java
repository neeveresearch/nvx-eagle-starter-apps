...
import com.neeve.demo.pricingservice.messages.*;
...
final class Requestor {
    ...
    final private void getPriceUsingREST() throws Exception {
    }

    final private void getPriceUsingJava() throws Exception {
        GetPriceRequest request = GetPriceRequest.create();
        request.setSku(100);
        request.setCustomerId(257);
        _client.getPrice(request);
    }
