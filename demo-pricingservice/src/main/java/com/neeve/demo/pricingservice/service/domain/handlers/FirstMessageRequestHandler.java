...
final public class FirstMessageRequestHandler implements MessageHandler<FirstRequest, AgentStartedEvent, com.neeve.demo.pricingservice.state.Repository> {
    ...
    final public MessageView handle(final String origin,
                                    ...
                                    final com.neeve.demo.pricingservice.state.Repository repository) throws Exception {
